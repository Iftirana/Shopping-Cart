...
var add1 = document.getElementById("add1");
    add1.onclick = function(){
      add1.style.backgroundColor = "#595959";
      add1.innerHTML = "Wird in den Watrenkorb gelegt";
      setTimeout(function(){
        add1.innerHTML = "Add to Cart";
        add1.style.backgroundColor = "";
   }, 1000)
  }
  var add2 = document.getElementById("add2");
  add2.onclick = function(){
    add2.style.backgroundColor = "#595959";
    add2.innerHTML = "Wird in den Watrenkorb gelegt";
      setTimeout(function(){
        add2.innerHTML = "Add to Cart";
        add2.style.backgroundColor = "";
   }, 1000)
  }
  var add3 = document.getElementById("add3");
  add3.onclick = function(){
    add3.innerHTML = "Wird in den Watrenkorb gelegt";
    add3.style.backgroundColor = "#595959";
    setTimeout(function(){
      add3.innerHTML = "Add to Cart";
      add3.style.backgroundColor = "";
   }, 1000)
  }
  var add4 = document.getElementById("add4");
  add4.onclick = function(){
    add4.innerHTML = "Wird in den Watrenkorb gelegt";
    add4.style.backgroundColor = "#595959";
    setTimeout(function(){
      add4.innerHTML = "Add to Cart";
